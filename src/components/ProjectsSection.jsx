...
const projects = [
  ...
  },
  {
    ...
    description:
      "Fast Pizza — a React + Vite + Tailwind web app with Redux Toolkit for state management, featuring dynamic menu browsing, cart operations, order management, and geolocation-based address resolution via public APIs.",
    image: "/projects/project3.png",

    tags: ["React", "Node.js", "Stripe", "Redis", "React Router"],
    demoUrl: "https://pizza-menu-nu-three.vercel.app",
    githubUrl: "https://github.com/Omar-darhous/pizza-menu",
    featured: true,
  ...
  },
  {
    ...
    description:
      "WorldWise a React + Vite application with interactive maps, geolocation, contextual city & country lists, reusable components, custom hooks, and modular state management for lightweight location based exploration.",
    ...
    demoUrl: "https://world-wise-three-tau.vercel.app/",
    githubUrl: "https://github.com/Omar-darhous/world-wise",
    featured: true,
  ...
  },
  {
    ...
    description:
      "A simple and modern Weather App that allows users to check real-time weather information for any city around the world. The app provides temperature, humidity, wind speed, and weather conditions using a clean and responsive UI.",
  ...
  },
  {
    ...
    demoUrl: "https://ricepe-app.vercel.app",
